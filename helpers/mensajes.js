...
const mostrarMenu = () => {
    ...
    //resolveremos con un new Promise()
...
const pausa = () => {
    ...
    return new Promise( resolve => {
        ...
        readline.question(`\nPresione ${'ENTER'.green} para continuar\n`, (opt) => {
            //cerrar el readline de lo contrario se va aquedar esperando informacion
            readline.close();
            //llamamos el resolve para resolver la promesa
            //no se pone nada dentro del resolve() porque no interesa nada de lo que escriba el usuario
            resolve();
        });    
    });
